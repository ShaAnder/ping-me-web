...
const DeleteAccountButton: React.FC<DeleteAccountButtonProps> = ({
	...
	return (
		<>
			...
			>
				<Typography sx={{ mb: 2 }}>
					Are you sure you wish to delete your account <b>{user.username}</b>?
					<br />
					This action cannot be undone and will delete all your data including
					any servers you created and messages.
					<br />
					<br />
