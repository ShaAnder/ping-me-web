...
const ForgotPassword: React.FC = () => {
	...
	// Formik submit handler — Supabase sends the recovery email itself and
	// redirects the user back to /reset with a recovery session attached.
	const onSubmit = async (
		...
		try {
			...
			setErrors({
				email: err?.message ?? "Unable to send reset email. Please try again.",
			});
		} finally {
			setSubmitting(false);
		}
