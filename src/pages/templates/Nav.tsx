...
interface NavProps {
	...
	serverName?: string;
	// Overrides the plain-text title with custom content (e.g. a dropdown
	// menu). Home.tsx/Popular.tsx don't pass this and keep plain text.
	titleContent?: ReactNode;
}

const Nav = ({ rightAction, serverName, titleContent }: NavProps) => {
